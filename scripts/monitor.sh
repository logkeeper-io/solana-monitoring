...
##### optional:        #
identityPubkey="xxxx"      # identity pubkey for the validator, insert if autodiscovery fails
voteAccount="xxxxx"         # vote account address for the validator, specify if there are more than one or if autodiscovery fails
...
binDir="/root/.local/share/solana/install/active_release/bin/"
rpcURL="http://api.testnet.solana.com"              # default is localhost with port number autodiscovered, alternatively it can be specified like http://custom.rpc.com:port
